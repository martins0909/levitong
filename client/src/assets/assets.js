...
import levitonimage from "./levitonimage.png";
...
export const blogCategories = ['All', 'Technology', 'startup', 'Lifestyle', 'Finance', 'Health', 'Education', 'Entertainment'];
...
export const footer_data = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Twitter", url: "https://twitter.com/LEVITONG1_", icon: Twitter },
      { name: "Facebook", url: "https://facebook.com/yourusername", icon: Facebook },
      { name: "YouTube", url: "https://youtube.com/@levitongtutorial", icon: Youtube },
      {
        name: "LinkedIn",
        url: "https://linkedin.com/in/madueke-martins-0921a6185?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        icon: Linkedin,
      },
    ],
  },
